            ...
            <div className="flex-1 text-center sm:text-left">
              ...
              {store.location && (
                <div className="flex items-center gap-1.5 mt-4 justify-center sm:justify-start">
                  ...
                  <span className="text-xs font-medium text-gray-500">{store.location}</span>
                </div>
              )}
            </div>
                ...
                <div key={i} className="bg-gray-50 rounded-2xl p-4">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-xs font-medium text-gray-500">{r.role}</p>
                    </div>
                  </div>
                </div>
              ))}
              ...
              <div key={i} className="bg-white rounded-2xl p-5 shadow-sm border border-gray-100">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs font-medium text-gray-500">{r.role} · {store.location}</p>
                  </div>
                </div>
              </div>
            ))}
      ...
      <div className="max-w-3xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 mb-3">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-xs font-medium text-gray-500">WhatsApp / Phone</p>
