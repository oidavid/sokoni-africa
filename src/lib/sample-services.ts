export const SAMPLE_SERVICES_BY_SUBCATEGORY: Record<string, Array<{
  ...
  massage: [
    ...
    { name: 'Sports & Recovery Massage', description: 'Targeted massage for athletes and active people. Reduces muscle soreness, improves flexibility and speeds up recovery.', price: 2000000, price_display: '₦20,000', in_stock: true, image_url: 'https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=400&q=80' },
...
export const SAMPLE_SERVICES: Record<string, Array<{
  ...
  events: [
    ...
    { name: 'Event Videography', description: 'Full event video coverage with cinematic editing. Drone shots available.', price: 7000000, price_display: '₦70,000', in_stock: true, image_url: 'https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=400&q=80' },
