...
export const SAMPLE_SERVICES_BY_SUBCATEGORY: Record<string, Array<{
  ...
  massage: [
    ...
    { name: 'Couples Massage (2 persons)', description: 'Side-by-side massage for two people in the same room. Perfect for date nights, anniversaries and special occasions.', price: 3500000, price_display: '₦35,000', in_stock: true, image_url: 'https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=400&q=80' },
    ...
    { name: 'Chair Massage (30 min)', description: 'Quick seated massage targeting neck, shoulders and upper back. Great for office visits, events and busy clients with limited time.', price: 700000, price_display: '₦7,000', in_stock: true, image_url: 'https://images.unsplash.com/photo-1519823551278-64ac92734fb1?w=400&q=80' },
    { name: 'Back, Neck & Shoulder Massage', description: 'Focused 45-minute session on the most common tension areas. Relieves headaches, stiffness and upper body pain. Quick and effective.', price: 1200000, price_display: '₦12,000', in_stock: true, image_url: 'https://images.unsplash.com/photo-1600334089648-b0d9d3028eb2?w=400&q=80' },
  ],
  ...
  nails: [
    ...
    { name: 'Pedicure & Foot Care', description: 'Full pedicure with soak, scrub, cuticle care, nail trim and polish. Leaves your feet soft, clean and beautiful.', price: 500000, price_display: '₦5,000', in_stock: true, image_url: 'https://images.unsplash.com/photo-1519823551278-64ac92734fb1?w=400&q=80' },
