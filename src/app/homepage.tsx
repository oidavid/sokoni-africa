        ...
        <div className="max-w-5xl mx-auto px-4 h-8 flex items-center justify-between">
          <span className="text-xs text-white/40 font-medium tracking-wide">
            ...
            <a href="https://intelsystechnology.com" target="_blank" rel="noopener noreferrer"
               className="text-white/60 hover:text-brand-accent transition-colors font-semibold">
              IntelSys Technologies
            </a>
          </span>
          <div className="flex items-center gap-3">
            <span className="text-white/30 text-xs">AI-Powered · Free Forever · 134 Countries</span>
          </div>
        </div>
      </div>
      ...
      <nav className="sticky top-0 z-50 bg-white/95 backdrop-blur border-b border-gray-100 shadow-sm">
        <div className="max-w-5xl mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <Link href="/" className="flex items-center gap-3 group">
            ...
            <span className="hidden sm:inline-flex items-center text-xs font-semibold text-brand-green bg-brand-light border border-brand-green/20 px-2.5 py-0.5 rounded-full">
              Free Forever
            </span>
          </Link>
          ...
          <div className="hidden md:flex items-center gap-6">
            ...
            <a href="#testimonials" className="text-sm font-medium text-gray-500 hover:text-brand-green transition-colors">Stories</a>
          </div>
        ...
        <div className="max-w-5xl mx-auto px-4 py-14">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10">
            ...
            <div className="md:col-span-2">
              <div className="text-2xl font-display font-bold text-white tracking-tight mb-1">earket</div>
              ...
              <div className="flex items-center gap-2">
                <span className="text-xs text-white/30 font-medium">A product of</span>
                <a href="https://intelsystechnology.com" target="_blank" rel="noopener noreferrer"
                   className="text-xs font-bold text-white/60 hover:text-brand-accent transition-colors tracking-wide uppercase">
                  IntelSys Technologies
                </a>
              </div>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li><Link href="/onboarding" className="text-sm text-white/55 hover:text-white transition-colors">Start Free</Link></li>
                <li><Link href="/login" className="text-sm text-white/55 hover:text-white transition-colors">Login</Link></li>
                <li><Link href="/dashboard" className="text-sm text-white/55 hover:text-white transition-colors">Dashboard</Link></li>
                <li><a href="#features" className="text-sm text-white/55 hover:text-white transition-colors">Features</a></li>
                <li><a href="#how-it-works" className="text-sm text-white/55 hover:text-white transition-colors">How It Works</a></li>
              </ul>
            </div>

            {/* Company links */}
            <div>
              <div className="text-xs font-bold text-white/30 uppercase tracking-widest mb-4">Company</div>
              <ul className="space-y-3">
                <li>
                  <a href="https://intelsystechnology.com" target="_blank" rel="noopener noreferrer"
                ...
                <li><Link href="/contact" className="text-sm text-white/55 hover:text-white transition-colors">Contact</Link></li>
        ...
        <div className="border-t border-white/8">
          <div className="max-w-5xl mx-auto px-4 py-5 flex flex-col sm:flex-row items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-4">
              ...
              <span className="text-xs text-white/20">Free Forever</span>
              <span className="text-white/10">·</span>
              <span className="text-xs text-white/20">134 Countries</span>
            </div>
          </div>
        </div>
      </footer>
