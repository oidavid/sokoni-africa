              ...
              <div className="p-3">
                ...
                {product.in_stock ? (
                  <div className="space-y-1.5">
                    {useWhatsApp && <WhatsAppOrderBtn product={product} store={store} />}
                    {useCart && (
                      <button onClick={() => { addToCart(product); setCartOpen(true) }}
                        className="w-full bg-brand-dark text-white text-xs font-semibold py-2.5 rounded-xl flex items-center justify-center gap-1.5 hover:bg-gray-800 transition-colors">
