                    ...
                    {!showWhatsAppForm ? (
                      ...
                      <div className="space-y-2 bg-gray-50 rounded-2xl p-3">
                        ...
                        <button onClick={() => {
                          ...
                          const customerWa = waPhone.replace(/\D/g, '').replace(/^0/, '234')
                          // Open merchant WhatsApp first
                          window.open(`https://wa.me/${merchantWa}?text=${encodeURIComponent(merchantMsg)}`, '_blank')
                          // Send confirmation to customer after short delay
                          setTimeout(() => {
                            if (customerWa.length >= 10) {
                              window.open(`https://wa.me/${customerWa}?text=${encodeURIComponent(customerMsg)}`, '_blank')
                            }
                          }, 1500)
