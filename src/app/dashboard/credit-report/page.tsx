        ...
        <div className="bg-white shadow-lg print:shadow-none" style={{ minHeight: '297mm' }}>
          ...
          <div className="px-8 py-6 print:px-6 space-y-6">
                  ...
                  <tbody>
                    {[
                      ...
                      ['Country', {
                        ...
                        'CI': "Côte d'Ivoire", 'ET': 'Ethiopia', 'RW': 'Rwanda',
                        'AU': 'Australia', 'IN': 'India', 'AE': 'UAE', 'BR': 'Brazil',
            ...
            <div className="border-t border-gray-200 pt-6 mt-4">
              <div className="flex items-start gap-3 bg-gray-50 rounded-xl p-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 leading-relaxed">
                    This report was automatically generated by Earket (earket.com), {
                      ['NG','GH','KE','ZA','SN','CI','CM','TZ','UG','ET'].includes(data.country)
                        ? 'a digital commerce platform empowering African businesses.'
                        : 'a global digital commerce platform empowering businesses in emerging and established markets.'
                    }
              ...
              {/* Dynamic regional tagline */}
              <p className="text-center text-xs text-gray-400 mt-4">
                earket.com · {
                  ['NG','GH','KE','ZA','SN','CI','CM','TZ','UG','ET','RW','MW','ZM','ZW','BI','GA','GM','GN','SL','LR','BJ','NE','ML','BF'].includes(data.country)
                    ? 'Empowering African Businesses'
                    : ['US','CA','GB','AU','NZ'].includes(data.country)
                    ? 'Empowering Businesses Everywhere'
                    : ['IN','PK','BD','LK','NP'].includes(data.country)
                    ? 'Empowering South Asian Businesses'
                    : ['AE','SA','QA','KW','BH','OM','JO','LB'].includes(data.country)
                    ? 'Empowering Middle Eastern Businesses'
                    : ['BR','MX','CO','AR','PE','CL','VE'].includes(data.country)
                    ? 'Empowering Latin American Businesses'
